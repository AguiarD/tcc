  ...
  <body>
    ...
    <main>
      ...
      <div class="containerInserir">
        <nav>
          <a class="muda btn btn-info btnVoltar" href="lancamentoIncluir.php" onclick="">Incluir</a>
        </nav>
      </div>
          ...
          <table class='table table-sm table-striped table-hover table-responsive-md text-center'>
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_array($result_select)) {
                ...
                $editar = '<a href="lancamentoEditar.php?id='.$row['idLancamento'].'">Edit</a>';
                $excluir = '<a href="lancamentos.php?removerId='.$row['idLancamento'].'">Exc</a>';
      ...
      <?php 
        ...
        if (isset($_GET['removerId'])) {
          ...
          if ($executar) {
            ...
            echo "<script>window.open('lancamentos.php', '_self')</script>";
          }
        }
